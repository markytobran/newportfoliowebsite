...
<template>
  <section class="h-full lg:h-screen w-full lg:w-screen flex flex-col justify-center">
    <div class="flex flex-col xl:flex-row items-start xl:items-center">
      <GlassCard class="w-full md:w-11/12 xl:w-5/12 h-full text-white mb-8 skills" title="My skills">
      ...
      <!--SKILL Section-->
      <div class="w-full xl:w-1/2 h-full xl:ml-24 xl:translate-y-12 mb-32 md:mb-0 md:pb-10">
