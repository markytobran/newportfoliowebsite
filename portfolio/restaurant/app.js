...
document.getElementById('formGroupExampleInput').addEventListener('blur', validateName)

document.getElementById('formGroupExampleInput2').addEventListener('blur', validatePhone)

document.getElementById('formGroupExampleInput3').addEventListener('blur', validateDate)
